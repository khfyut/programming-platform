...
public class WrongBookController {
    ...
    public ResultUtil getWrongBookDetail(@PathVariable Long id) {
        try {
            return ResultUtil.success(wrongBookService.getWrongBookItemById(id));
        } catch (Exception e) {
            return ResultUtil.error(e.getMessage());
        }
    }
    ...
    public ResultUtil markReviewStatus(HttpServletRequest request, @RequestBody Map<String, Object> params) {
        try {
            ...
            wrongBookService.updateWrongBookItemStatus(id, status);
    ...
    public ResultUtil deleteWrongItem(@PathVariable Long id) {
        try {
            wrongBookService.removeWrongBookItem(id);
            return ResultUtil.success(null);
        } catch (Exception e) {
            return ResultUtil.error(e.getMessage());
        }
